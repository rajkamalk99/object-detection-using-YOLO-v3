...
ap.add_argument('-c', '--config', required=True, help='path to yolo configuration file')
ap.add_argument('-w', '--weights', required=True, help='path to yolo pre-processed weights')
